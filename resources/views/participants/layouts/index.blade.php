                                ...
                                <div class="row">
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            ...
                                            <h4 class="card-title">Silahkan memilih jenis pelatihan yang akan anda ikuti
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="ml-md-auto py-10 py-md-0">
                                        {{-- <a href="#" class="btn btn-primary btn-border btn-round mr-2">Manage</a> --}}
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="/assets/participant/flags/id.png"
                                                                    alt="indonesia">
                                                            </div>
                                                        </td>
                                                        <td>Indonesia</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="/assets/participant/flags/us.png"
                                                                    alt="united states">
                                                            </div>
                                                        </td>
                                                        <td>USA</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="/assets/participant/flags/au.png"
                                                                    alt="australia">
                                                            </div>
                                                        </td>
                                                        <td>Australia</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="/assets/participant/flags/ru.png"
                                                                    alt="russia">
                                                            </div>
                                                        </td>
                                                        <td>Russia</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="/assets/participant/flags/cn.png"
                                                                    alt="china">
                                                            </div>
                                                        </td>
                                                        <td>China</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="/assets/participant/flags/br.png"
                                                                    alt="brazil">
                                                            </div>
                                                        </td>
                                                        <td>Brasil</td>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex">
                                    <div class="avatar">
                                        <img src="/assets/participant/logoproduct.svg" alt="..."
                                ...
                                <div class="d-flex">
                                    <div class="avatar">
                                        <img src="/assets/participant/logoproduct3.svg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="flex-1 pt-1 ml-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-list">
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="/assets/participant/jm_denis.jpg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="/assets/participant/chadengle.jpg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                        <div class="info-user ml-3">
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="/assets/participant/talha.jpg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                        <div class="info-user ml-3">
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="/assets/participant/mlane.jpg" alt="..."
                                                class="avatar-img rounded-circle">
                                        </div>
                                        <div class="info-user ml-3">
