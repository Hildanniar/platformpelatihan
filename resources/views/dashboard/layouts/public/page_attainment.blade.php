        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">{{ $type_trainings->name }}</h1>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            <div class="col-md-10">
                ...
                <br>
                <center>
                    <h1>{{ $type_trainings->name }}</h1>
                </center>
                <p>By. </p>
                <img src="https://source.unsplash.com/1200x400?{{ $type_trainings->name }}"
                    alt="{{ $type_trainings->name }}" class="card-img-top">
                @endif
