            ...
            <div class="col-lg-4 col-md-6 footer-about">
                <div
                    ...
                    <a href="index.html" class="navbar-brand">
                        <h2 class="m-0 text-white">Platform Pelatihan</h2>
                    </a>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0">Jl.Bali No.3, Krajan, Mejayan
                                Caruban, Kab.Madiun, Jawa Timur</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-envelope-open text-primary me-2"></i>
                            <p class="mb-0">perpustakaan.madiunkab@gmail.com</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-telephone text-primary me-2"></i>
                            <p class="mb-0">0351-383473</p>
                        </div>
                        <div class="d-flex mt-4">
                            <a class="btn btn-primary btn-square me-2" href="https://perpustakaan.madiunkab.go.id/"><i
                                    class="fa fa-globe"></i></a>
                            <a class="btn btn-primary btn-square me-2"
                                href="https://www.youtube.com/channel/UC13Uwz-OCgMsfZYBcDZdsEA"><i
                                    class="fab fa-youtube fw-normal"></i></a>
                            <a class="btn btn-primary btn-square" href="https://www.instagram.com/perpus.madiunkab/"><i
