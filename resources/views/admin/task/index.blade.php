                ...
                <div class="page-inner py-5">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                        ...
                        <div class="ml-md-auto py-2 py-md-0">
                            <a href="/admin/task/create" class="btn btn-white btn-border btn-round mr-2"><i
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-head-row card-tools-still-right">
                                <h4 class="card-title">Tabel Data Tugas Pelatihan</h4>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action-button mx-auto text-end">
                                                                <a href="/admin/task/{{ $t->id }}/edit"
                                                                    class="badge btn-warning"><i class="far fa-edit""></i>
                                                                    Edit</a>
                                                                <form action="/admin/task/{{ $t->id }}"
