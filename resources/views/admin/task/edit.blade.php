                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-head-row card-tools-still-right">
                                <h4 class="card-title">Edit Data Tugas Pelatihan</h4>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <form method="post" action="/admin/task/{{ $tasks->id }}" class="mb-5"
                                ...
                                <div class="form-group form-floating-label">
                                    ...
                                    <select class="form-control input-solid" name="type_training_id">
                                        @foreach ($type_trainings as $type_training)
                                            @if (old('type_training_id', $tasks->type_training_id) == $type_training->id)
                                ...
                                <div class="form-group form-floating-label">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('task_name', $tasks->task_name) }}" required>
                                    @error('task_name')
                                ...
                                <div class="form-group form-floating-label">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('end_date', $tasks->end_date) }}">
                                    @error('end_date')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
